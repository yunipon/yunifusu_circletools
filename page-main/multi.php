      ...
      <div class="editor-right">
        <div class="card">
          ...
          <div>
            ...
            <p style="background-color: #E0E0E0; color: #000000;">◆SE：〇〇　ここから/ここまで　←灰色ハイライト</p>
            <p style="color: #000000;">◆SE方向：　←距離感や方向など、演出上特別指定したいものがあれば（希望は通らない可能性もあります）　←無地</p>
            <p style="background-color: #E0E0E0; color: #000000;">■編集：〇〇　ここから/ここまで　←SEと同じ色になります（黒文字+灰色ハイライト）</p>
            ...
            <p style="color: #E50000; font-weight: bold;">□演技：〇〇　（ここから/ここまで）範囲指定はしてもしなくてもOK　←キャラ文字色</p>
            <p style="color: #E50000; font-weight: bold;">＊A1　吐息　10秒/回　←記号+数字+演技名で管理　キャラ文字色</p>
            <p style="background-color: #FFDADA; color: #E50000;">（キャラ名｜ループ：A1吐息　ここから）←各キャラの文字色&ハイライトになります）</p>
